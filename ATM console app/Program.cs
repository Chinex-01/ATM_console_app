...
if (answer == 1)
{
    ...
    {
        new Customer { Name = "John", AccountNumber = "2301110001", Pin = 1234, amount = 0000},
        new Customer { Name = "Mary", AccountNumber = "2301110002", Pin = 2222, amount = 0000},
        new Customer { Name = "David", AccountNumber = "2301110003", Pin = 3333, amount = 0000},
        new Customer { Name = "Sarah", AccountNumber = "2301110004", Pin = 4444, amount = 0000},
        new Customer { Name = "James", AccountNumber = "2301110005", Pin = 5555, amount = 0000},
    };
